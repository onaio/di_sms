...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'di_sms')
...
SECRET_KEY = '2lm!q-xl&b7bkh+hz3po8*p1(t6m52-vxx(=gmzy-)8^mv+e(0'
...
ROOT_URLCONF = 'di_sms.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'di_sms.wsgi.application'
